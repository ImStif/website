...
<head>
    ...
    <title>Panel<sup>v.2.28</sup></title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html">Inicio de sesión</a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>SB Admin Pro</strong> está repleto de funciones, componentes y mucho más de primera calidad.</p>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        Se han depositado 290,29 dólares en su cuenta!
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Hola a todos. Me pregunto si pueden ayudarme con un
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="text-truncate">Tengo las fotos que pidió el mes pasado, ¿cómo
                                            quiere que se las envíen?</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="text-truncate">El informe del mes pasado está muy bien, estoy muy contento con
                                            los progresos realizados hasta ahora, ¡seguid con el buen trabajo!</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-gray-500">El Perro Pollo · 2w</div>
                                    </div>
                                </a>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Resumen de los ingresos</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <div class="dropdown-header">Cabecera desplegable:</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Migración de servidores <span
                                    ...
                                    <h4 class="small font-weight-bold">Base de datos de clientes <span
                                            class="float-right">60%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 60%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Detalles del pago <span
                                            class="float-right">80%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Configuración de la cuenta <span
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Añade algunas ilustraciones svg de calidad a tu proyecto por cortesía de <a
                                            target="_blank" rel="nofollow" href="https://undraw.co/">unDraw</a>, a
                                            colección constantemente actualizada de bellas imágenes svg que puedes utilizar
                                            ¡completamente gratis y sin atribución!</p>
                                    <a target="_blank" rel="nofollow" href="https://undraw.co/">Buscar ilustraciones en
                                        unDraw &rarr;</a>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>SB Admin 2 hace un uso extensivo de las clases de utilidad de Bootstrap 4 con el fin de reducir
                                        la hinchazón de CSS y el bajo rendimiento de la página. Las clases CSS personalizadas se utilizan para crear
                                        componentes personalizados y clases de utilidad personalizadas.</p>
                                    <p class="mb-0">Antes de trabajar con este tema, debes familiarizarte con el framework
                                        Bootstrap, especialmente las clases de utilidad.</p>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="login.html">Cierre de sesión</a>
                </div>
            </div>
        </div>
    </div>
